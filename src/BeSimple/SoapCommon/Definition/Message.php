...
class Message
{
    ...
    public function add($name, $phpType, $nillable = false, $minOccurs = null, $maxOccurs = null, $restriction = array())
    {
        if ($phpType instanceof TypeInterface) {
            $phpType = $phpType->getPhpType();
        }

        $this->parts[$name] = new Part($name, $phpType, $nillable, $minOccurs, $maxOccurs, $restriction);

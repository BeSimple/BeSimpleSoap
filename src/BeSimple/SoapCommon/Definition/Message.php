...
class Message
{
    ...
    public function add($name, $phpType, $nillable = false, $minOccurs = null, $maxOccurs = null, $pattern = null)
    {
        if ($phpType instanceof TypeInterface) {
            $phpType = $phpType->getPhpType();
        }

        $this->parts[$name] = new Part($name, $phpType, $nillable, $minOccurs, $maxOccurs, $pattern);
